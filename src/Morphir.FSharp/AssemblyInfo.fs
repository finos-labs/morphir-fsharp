...
[<assembly: AssemblyTitleAttribute("Morphir.FSharp")>]
[<assembly: AssemblyProductAttribute("Morphir.FSharp")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Morphir.FSharp"
    let [<Literal>] AssemblyProduct = "Morphir.FSharp"
